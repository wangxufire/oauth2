...
public class AppController extends AbstractController {
  ...
  public void create(@Valid @RequestBody App app) throws AuthServiceException {
  ...
  public void audit(@PathVariable("id") ObjectId id) throws AuthServiceException {
    appService.audit(id);
  }
  ...
  public void update(@Valid @RequestBody App app) throws AuthServiceException {
